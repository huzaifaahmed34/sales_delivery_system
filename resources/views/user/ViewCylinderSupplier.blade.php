  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
           <h4 class="modal-title">Delete Cylinder Supplier</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
     
      </div>
      <div class="modal-body">
     Are You sure you want to delete this Cylinder Supplier
      ...
      <form id=form1>
        ...
        <div class="row"> 
          <div class="col-lg-6">
              ...
              <input type="text" class="form-control" id="name" name=customer_name placeholder="Enter Cylinder Supplier Name" value={{@$Cylinder}}>
              ...
              <input type="email" class="form-control" id="email" name=email placeholder="Enter Cylinder Supplier Email" value={{@$Cylinder}}>
              ...
              <input type="text" class="form-control" id="phone" name=phone placeholder="Enter Cylinder Supplier Phone No" >
              ...
              <input type="text" class="form-control" id="city" name=city placeholder="Enter Cylinder Supplier Name" value={{@$Cylinder}}>
              ...
              <textarea type="textar" class="form-control" id="address" name=address value={{@$Cylinder}}>
</textarea>
                </div>
                    </div>
                      <div class="col-lg-6">
...
function show_data(){
    $.ajax({
      ...
      url:'<?php echo url('admin/ShowCylinderSupplier')?>',
      async:false,
      dataType:'json',
...
var id=$(this).attr('data');
  ...
  var url='<?php echo url('admin/CylinderSupplierEdit/')?>/'+id+'';
...
$('input[name=customer_name]').val(response.supplier_name);
...
$('#btnDelete').unbind().click(function(){
  var url='<?php echo url('admin/CylinderSupplierDelete/')?>/'+id+'';
...
var id=$('input[name=id]').val();
  ...
  var url='<?php echo url('admin/CylinderSupplierUpdate')?>';
